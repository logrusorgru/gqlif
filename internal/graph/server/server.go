...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.set":
		...
		return e.complexity.Mutation.Set(childComplexity, args["name"].(string), args["value"].(inputs.InputValue)), true
	...
	case "Query.get":
		...
		return e.complexity.Query.Get(childComplexity, args["name"].(string)), true

	case "Value.name":
		if e.complexity.Value.Name == nil {
			break
		}

		return e.complexity.Value.Name(childComplexity), true

	case "Value.valueType":
		if e.complexity.Value.ValueType == nil {
			break
		}

		return e.complexity.Value.ValueType(childComplexity), true
...
func (ec *executionContext) dir_allowValueType_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
...
func (ec *executionContext) _Mutation_set(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().Set(rctx, args["name"].(string), args["value"].(inputs.InputValue))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_get(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Get(rctx, args["name"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Value_name(ctx context.Context, field graphql.CollectedField, obj *types.Value) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Value_valueType(ctx context.Context, field graphql.CollectedField, obj *types.Value) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) unmarshalInputInputValue(ctx context.Context, obj interface{}) (inputs.InputValue, error) {
	var it inputs.InputValue
	...
	for k, v := range asMap {
		...
		case "valueType":
			...
			directive1 := func(ctx context.Context) (interface{}, error) {
				...
				if ec.directives.AllowValueType == nil {
					return nil, errors.New("directive allowValueType is not implemented")
				}
				return ec.directives.AllowValueType(ctx, obj, directive0, field, allow)
			}
...
func (ec *executionContext) unmarshalInputValueTypeAllow(ctx context.Context, obj interface{}) (directives.ValueTypeAllow, error) {
	var it directives.ValueTypeAllow
	var asMap = obj.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "allow":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("allow"))
			it.Allow, err = ec.unmarshalNBoolean2bool(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "set":
			out.Values[i] = ec._Mutation_set(ctx, field)
...
func (ec *executionContext) _Value(ctx context.Context, sel ast.SelectionSet, obj *types.Value) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "name":
			out.Values[i] = ec._Value_name(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "valueType":
			out.Values[i] = ec._Value_valueType(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
